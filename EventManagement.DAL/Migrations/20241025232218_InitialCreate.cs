    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Menu__3213E83F85B71AF4", x => x.id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Rol__3213E83F03C945D6", x => x.id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isPrivate = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false),
                    registrationDate = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "NOW()"),
                    isPaid = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MenuRol__9E2C41E328DD3A4D", x => new { x.roleID, x.menuID });
                    table.ForeignKey(
                        name: "FK__MenuRol__menuID__4AB81AF0",
                        column: x => x.menuID,
                        principalTable: "Menu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK__MenuRol__roleID__49C3F6B7",
                        column: x => x.roleID,
                        principalTable: "Rol",
                        principalColumn: "id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Users__roleID__46E78A0C",
                        column: x => x.roleID,
                        principalTable: "Rol",
                        principalColumn: "id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    comment = table.Column<string>(type: "text", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    commentDate = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "NOW()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    type = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    notificationDate = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "NOW()"),
                    isRead = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    paymentDate = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "NOW()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    hasAccess = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    userID = table.Column<int>(type: "int", nullable: false),
                    eventID = table.Column<int>(type: "int", nullable: false),
                    userMarkAttendance = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false),
                    organizerMarkAttendance = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false),
                    isCreator = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false),
                    hasPaid = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Rol__72E12F1B340BD3F5",
                table: "Rol",
                column: "name",
                unique: true);
